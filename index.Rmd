...
Stamey et al. (1989) was interested in the relation between prostate specific antigen (PSA) and several clinical measures, including log cancer volume (\texttt{lcavol}), log prostate weight (\texttt{lweight}), age, log of benign
prostatic hyperplasia amount (\texttt{lbph}), seminal vesicle invasion (\texttt{svi}), log of capsular penetration (\texttt{lcp}), the
Gleason score (\texttt{gleason}), and percent of Gleason scores 4 or 5 (\texttt{pgg45}). 
